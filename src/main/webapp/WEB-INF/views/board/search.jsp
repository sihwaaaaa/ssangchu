		...
		<div class="container h-100">
			<div class="blog-banner">
				<div class="text-center">
					<h1>내가 궁금한 <span style="color: #78e284">상추</span>만 보기!</h1>
					<nav aria-label="breadcrumb" class="banner-breadcrumb">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/">Home</a></li>
							<li class="breadcrumb-item active" aria-current="page">"${page.cri.keyword}"</li>
						</ol>
					</nav>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-12">
					<!-- Start Filter Bar -->
						...
						<h6>"<span style="color: #78e284"> ${page.cri.keyword} </span>" 검색결과</h6>
						</div>
								...
								<ul class="pagination">
									...
									<c:if test="${page.doublePrev}">
										<li class="page-item"><a class="page-link"
											href="search${page.cri.queryString}&pageNum=${page.startPage -1}"><i
												class="fas fa-angle-double-left"></i></a></li>
									</c:if>
									<c:if test="${page.prev}">
										<li class="page-item"><a class="page-link"
											href="search${page.cri.queryString}&pageNum=${page.cri.pageNum-1}"><i
									...
									<c:forEach begin="${page.startPage}" end="${page.endPage}"
										...
										<li class="page-item ${page.cri.pageNum == i ? 'active' : ''}"><a
											class="page-link"
											href="search${page.cri.queryString}&pageNum=${i}">${i}</a></li>
									</c:forEach>
									...
									<c:if test="${page.doubleNext}">
										<li class="page-item"><a class="page-link"
											href="search${page.cri.queryString}&pageNum=${page.endPage + 1}"><i
