...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  ...
  <title>상추마켓</title>
  <link rel="icon" href="${pageContext.request.contextPath}/resources/img/salad_small.png" type="image/png">
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/vendors/icofont/icofont.min.css">
