  ...
  <section class="login_box_area section-margin">
    <div class="container">
      <div class="flex-column clearfix">
        <div class="mb-5">
          <h4>개인정보 이용동의</h4>
          <textarea rows="10" class="blog_right_sidebar form-control different-control w-100">
...
개인정보의 수집 및 이용 동의
1. 개인정보의 수집 및 이용 목적
    가. 서비스 제공에 관한 업무 이행 - 컨텐츠 제공, 특정 맞춤 서비스 제공
    나. 회원관리
    - 회원제 서비스 이용 및 제한적 본인 확인제에 따른 본인확인, 개인식별, 가입의사 확인, 가입 및 가입횟수 제한, 공지사항 전달
...
정보주체는 개인정보 수집에 동의를 거부할 권리가 있습니다. 다만, 필수 항목에 대한 동의를 거부할 시 저희가 제공하는 서비스를 이용할 수 없습니다.
          ...
          <div class="float-right my-4 privacyTerm">
            <input type="checkbox" id="privacy" name="privacy">
            <label for="privacy">개인정보 이용항목에 동의합니다.</label>
            <p class="err-msg"></p>
          </div>
        </div>
      </div>
        <div class="flex-column clearfix">
          <h4>서비스 이용동의</h4>
          <textarea rows="10" class="blog_right_sidebar form-control different-control w-100 h-100">제 1 장 총 칙



  제 1 조 (목적)
  이 약관은 상추마켓(이하 "사이트"라 합니다)에서 제공하는 인터넷서비스(이하 "서비스"라 합니다)의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다.
  ...
  (시행일) 이 약관은 2023년 03월부터 시행합니다.</textarea>
          <div class="float-right my-4 termsOfUse">
            <input type="checkbox" id="termsOfUse" name="termsOfUse">
            <label for="termsOfUse">서비스 이용약관에 동의합니다.</label>
            <p class="err-msg"></p>
          </div>

        </div>
      <div class="d-flex justify-content-center">
        <button class="button button--active px-3 py-2 mx-2" id="backbtn">이전</button>
        <button href="" class="button button--active px-3 py-2 mx-2" id="nextbtn">다음</button>
      </div>
    </div>
  </section>
...
<script>
  $(function () {
    ...
    $("#nextbtn").click(function (){
      ...
      var termsOfUse = $("#termsOfUse").is(":checked");

      var str =  "이용약관에 동의해주세요"
      if(!privacy){

        console.log("error!");
        $(".privacyTerm .err-msg").text(str);

      } else{
        $(".privacyTerm .err-msg").text("");
      }

      if(!termsOfUse){

        console.log("error!");
        $(".termsOfUse .err-msg").text(str);

      } else{
        $(".termsOfUse .err-msg").text("");
      }

      if(!privacy || !termsOfUse){
        return false;
      }
